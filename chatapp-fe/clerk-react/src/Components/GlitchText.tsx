...
const GlitchText: FC<GlitchTextProps> = ({
  ...
  const inlineStyles: CustomCSSProperties = {
    ...
    '--after-shadow': enableShadows ? '-5px 0 green' : 'none',
    '--before-shadow': enableShadows ? '5px 0 black' : 'none'
  };

  const baseClasses = 'text-white  font-black relative mx-auto select-none cursor-pointer';
